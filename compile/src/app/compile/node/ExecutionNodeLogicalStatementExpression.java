...
public class ExecutionNodeLogicalStatementExpression extends ExecutionNode
{
    ...
    public void Evaluate(Program program, ProgramState state, ParseTree parseTree)
    {
        ...
        while (nodeStack.size() > 0)
        {
            ...
            else if (curNode.leftSide != null && curNode.rightSide != null && curNode.leftSide.visited && curNode.rightSide.visited)
            {
        ...
        System.out.println("Final result is: " + state.returnValue.valueAsString());
        System.out.println("Stack size is: " + valueStack.size());
    }
    ...
    {
        // this converts something to something. Joke. This finalizes function
        // calls,
