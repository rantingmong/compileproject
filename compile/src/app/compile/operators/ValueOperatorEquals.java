...
public class ValueOperatorEquals extends ValueOperator
{
    @Override
    public boolean IsOperator(String value)
    {
        return value.toLowerCase().equals("equal");
    }
    ...
    public DataValue Process(DataValue lhs, DataValue rhs)
    {
        ...
        {
            System.err.println("Equals operation was not successful. Returning default value of FALSE.");
