...
public class Text extends JFrame implements ActionListener
{
    ...
    private TextArea          textArea         = new TextArea();
    private TextArea          console          = new TextArea();
    private MenuBar           menuBar          = new MenuBar(); // first,
                                                                 // create a
                                                                 // MenuBar item
    private Menu              file             = new Menu();    // our File
                                                                 // menu
    // what's going in File? let's see...
    private MenuItem          openFile         = new MenuItem(); // an open
                                                                 // option
    private MenuItem          saveFile         = new MenuItem(); // a save
                                                                 // option
    private MenuItem          compile          = new MenuItem();
    private MenuItem          close            = new MenuItem(); // and a close
                                                                 // option!
    public Text()
    {
        redirectSystemStreams();
        ...
        {
            /*
             * public void keyPressed(KeyEvent e) { //CALL SYNTAXCHECKER HERE
    ...
    public void process(String input) throws IOException
    {
        ...
        ConverterProgram cxp = new ConverterProgram();
        cxp.process(pt, cmp);
>>>>>>> e1740c10b36ca24585a2b1a42fe4f921cff6de5f
