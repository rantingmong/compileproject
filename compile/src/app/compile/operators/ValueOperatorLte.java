...
public class ValueOperatorLte extends ValueOperator
{
    @Override
    public boolean      IsOperator  (String value)
    {
        return value.toLowerCase().equals("lte");
    }
    ...
    public DataValue    Process     (DataValue lhs, DataValue rhs)
    {
        ...
        System.err.println("Less than or equal to operation was not successful. Returning default value of FALSE.");
