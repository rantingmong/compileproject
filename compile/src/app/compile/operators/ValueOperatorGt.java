...
public class ValueOperatorGt extends ValueOperator
{
    @Override
    public boolean      IsOperator  (String value)
    {
        return value.toLowerCase().equals("gt");
    }
    ...
    public DataValue    Process     (DataValue lhs, DataValue rhs)
    {
        ...
        {
            System.err.println("Greater than operation was not successful. Returning default value of FALSE.");
